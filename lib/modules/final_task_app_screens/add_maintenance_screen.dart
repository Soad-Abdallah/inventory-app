                          ...
                          builder: (context)=> defulteButton(
                            ...
                            function: (){
                              if(formKey.currentState!.validate()){
                                model.MaintenanceTyp = MaintenanceTypController.text;
                                model.startMaintenanceDate = startMaintenanceDateController.text;
                                model.EndMaintenanceDate = EndMaintenanceDateController.text;
                                ...
                                FinalTaskCubit.get(context).MaintenanceAdd(
                                  ...
                                  startMaintenanceDate: model.startMaintenanceDate, 
                                  EndMaintenanceDate: model.EndMaintenanceDate, 
                                  worker: model.worker,
                                  Note: model.Note,
                                  );
                            }    
